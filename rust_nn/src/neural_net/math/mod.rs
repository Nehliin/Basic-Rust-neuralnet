...
mod tests {
    ...
    fn nabla_weights() {
        ...
        vec![ 4.66954098e-02,  4.01424442e-02,  3.50094084e-02,  3.43473710e-04,
        ...
        vec![ 8.59265745e-02,  7.38681325e-02,  6.44225749e-02,  6.32043266e-04,
        ...
        vec![ 5.45942426e-02,  4.69328002e-02,  4.09314779e-02,  4.01574526e-04,
        ...
        vec![ 2.22086194e-05,  1.90919893e-05,  1.66506864e-05,  1.63358175e-07,
        ...
        vec![ 9.63278379e-02,  8.28097424e-02,  7.22208163e-02,  7.08551012e-04,
        ...
        vec![ 4.14386889e-04,  3.56234213e-04,  3.10682354e-04,  3.04807267e-06,
        ...
        vec![ 1.38118705e-03,  1.18735919e-03,  1.03553094e-03,  1.01594877e-05,
        ...
        vec![ 4.57259547e-02,  3.93090368e-02,  3.42825693e-02,  3.36342766e-04,
        ...
        vec![-4.86164009e-05, -4.17938545e-05, -3.64496519e-05, -3.57603792e-07,
        ...
        assert_eq!(expected.len(), result.get_rows().len());
        assert_eq!(expected, *result.get_rows());
        for (i,row) in result.get_rows().iter().enumerate() {
            println!("Iteration {}", i);
            assert_eq!(expected[i].len(), row.len());
            assert_eq!(expected[i], *row);
        }
    }
